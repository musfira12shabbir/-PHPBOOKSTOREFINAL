                          ...
                          <div class="sign-in-from bg-primary rounded">
                              ...
                              <form class="mt-4 form-text" method="post">
                                  <div class="form-group">
                                      ...
                                      <input type="email" name="admin_email" class="form-control mb-0" id="exampleInputEmail1" placeholder="Enter email">
                                  </div>
                                  <div class="form-group">
                                      <label for="exampleInputPassword1">Password</label>
                                      <a href="#" class="float-right text-dark">Forgot password?</a>
                                      <input type="password" name="admin_pass" class="form-control mb-0" id="exampleInputPassword1" placeholder="Password">
                                  </div>
                                  ...
                                  <div class="sign-info text-center">
                                      <button type="submit" name="login" class="btn btn-white d-block w-100 mb-2">Sign in</button>
